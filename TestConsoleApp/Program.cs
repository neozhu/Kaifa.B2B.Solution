...
namespace TestConsoleApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //p.Read();
            AllocProcess p = new AllocProcess("c:\\szd_vendor_alloc_adhoc201606030.csv", "Server=10.10.205.147;Database=SCPRD;User ID=sa;Password=Suwmsdb_2015;Trusted_Connection=False", "wmwhse2");
            p.Read();
            Console.Read();
