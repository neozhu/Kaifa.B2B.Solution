...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 userCSharp"" version=""1.0"" xmlns:ns0=""http://kaifa.b2b.schemas/Pip3B2AdvanceShipmentNotification"" xmlns:s0=""http://kaifa.b2b.schemas/OrderShipment"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/s0:OrderShipment"">
    <xsl:variable name=""var:v1"" select=""userCSharp:StringTrimLeft(&quot;894720952&quot;)"" />
    ...
    <xsl:variable name=""var:v17"" select=""userCSharp:StringTrimLeft(&quot;YuQiXing@kaifa.cn&quot;)"" />
    <xsl:variable name=""var:v18"" select=""userCSharp:StringTrimLeft(&quot;(86-755) 83275000-36633&quot;)"" />
    <xsl:variable name=""var:v19"" select=""userCSharp:StringTrimLeft(&quot;Shipper&quot;)"" />
    <xsl:variable name=""var:v20"" select=""userCSharp:StringTrimLeft(&quot;Electronic Components&quot;)"" />
    <xsl:variable name=""var:v21"" select=""userCSharp:StringTrimLeft(&quot;Freight Forwarder&quot;)"" />
    <xsl:variable name=""var:v22"" select=""userCSharp:StringTrimLeft(&quot;Request&quot;)"" />
    <xsl:variable name=""var:v25"" select=""userCSharp:StringTrimLeft(&quot;Receiver&quot;)"" />
    <xsl:variable name=""var:v26"" select=""userCSharp:StringTrimLeft(&quot;098533326 &quot;)"" />
    <ns0:Pip3B2AdvanceShipmentNotification>
              ...
              <xsl:for-each select=""s0:ASIC"">
                <xsl:for-each select=""s0:ORDER"">
                  <xsl:for-each select=""s0:ORDERDETAIL"">
                    ...
                    <xsl:variable name=""var:v9"" select=""userCSharp:StringTrimLeft(&quot;SZD&quot;)"" />
                    <xsl:variable name=""var:v10"" select=""userCSharp:StringTrimLeft(&quot;PICK&quot;)"" />
                    <xsl:variable name=""var:v11"" select=""userCSharp:StringConcat(&quot;SZD&quot; , string(s0:STORERKEY/text()))"" />
      ...
      <ns0:thisDocumentGenerationDateTime>
        <xsl:variable name=""var:v23"" select=""userCSharp:dateTimeNow()"" />
        <ns0:DateTimeStamp>
          <xsl:value-of select=""$var:v23"" />
        </ns0:DateTimeStamp>
      </ns0:thisDocumentGenerationDateTime>
      <ns0:thisDocumentIdentifier>
        <xsl:variable name=""var:v24"" select=""userCSharp:ProprietaryDocumentIdentifier(&quot;SZD&quot; , &quot;ASN&quot;)"" />
        <ns0:ProprietaryDocumentIdentifier>
...
public string ProprietaryDocumentIdentifier(string Site,string msgType) {
            ...
            string seq = ""000001"";
            return string.Format(""{0}HUB{1}{2}{3}"", ""SZD"", msgType, str, seq);
        }
