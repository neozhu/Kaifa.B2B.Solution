namespace Kaifa.B2B.Orchestration._940.Mapping {
    ...
    public sealed class Map_To_InforShipmentOrder : Microsoft.XLANGs.BaseTypes.TransformBase {
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 userCSharp"" version=""1.0"" xmlns:ns0=""http://Kaifa.B2B.Schemas.InforAPI/InforShipmentOrder"" xmlns:s0=""http://Kaifa.B2B.Schemas.940.CM_940_Inbound"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/s0:CMInbound"">
    ...
    <xsl:variable name=""var:v4"" select=""userCSharp:StringTrimLeft(&quot;wmwhse1&quot;)"" />
    <xsl:variable name=""var:v5"" select=""./s0:Row[1]/s0:Site/text()"" />
    <xsl:variable name=""var:v7"" select=""./s0:Row[1]/s0:PullNo/text()"" />
    <xsl:variable name=""var:v8"" select=""./s0:Row[1]/s0:PO/text()"" />
    ...
    <xsl:variable name=""var:v13"" select=""s0:Row/s0:PrimeOnly/text()"" />
    <ns0:Message>
      <ns0:Head>
        <ns0:MessageType>
      ...
      <ns0:Body>
        <ns0:ShipmentOrder>
          <ns0:ShipmentOrderHeader>
            <xsl:variable name=""var:v6"" select=""userCSharp:SpiltSite(string($var:v5))"" />
            <ns0:StorerKey>
            ...
            <xsl:variable name=""var:v9"" select=""userCSharp:SpiltSite(string($var:v5))"" />
            <ns0:ConsigneeKey>
