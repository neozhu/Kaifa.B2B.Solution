...
namespace Kaifa.B2B.InforApiServiceAdapterProvider
{
    public class OrderShipmentGenerator
    {
        ...
        public XDocument Generator()
        {
            ...
            IEnumerable<XElement> vendorreports = Group(OrderShipment().ToList());
...
GROUP BY 
		...
		LOTTABLE02,LOTTABLE03,LOTTABLE06,SPREMARK   FOR XML AUTO,ELEMENTS", this._warehous, this._orderKey);
