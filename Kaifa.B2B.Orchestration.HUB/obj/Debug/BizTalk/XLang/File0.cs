...
namespace Kaifa.B2B.Orchestration.HUB
{

    [Microsoft.XLANGs.BaseTypes.PortTypeOperationAttribute(
        "Operation_1",
        new System.Type[]{
            typeof(Kaifa.B2B.Orchestration.HUB.__messagetype_Kaifa_B2B_Schemas_Wms_AdvancedShipNotice)
        },
        new string[]{
        }
    )]
    ...
    [Microsoft.XLANGs.BaseTypes.PortTypeOperationAttribute(
        "Operation_1",
        new System.Type[]{
            typeof(Kaifa.B2B.Orchestration.HUB.__messagetype_Kaifa_B2B_Schemas_RosettaNet_SGRTHUB4B2_MS_1_0_ShipmentReceiptNotification)
        },
        new string[]{
        }
    )]
    ...
    [Microsoft.XLANGs.BaseTypes.ServicePortsAttribute(
        ...
        new System.Type[] {
            typeof(Kaifa.B2B.Orchestration.HUB.PortType_ReceiveReceiptMessage),
            typeof(Kaifa.B2B.Orchestration.HUB.PortType_SendPip4B2Message)
        },
        new System.String[] {
    ...
    sealed internal class HUB_Orchestration : Microsoft.BizTalk.XLANGs.BTXEngine.BTXService
    {
        ...
        private static System.Guid _serviceId = Microsoft.XLANGs.Core.HashHelper.HashServiceType(typeof(HUB_Orchestration));
        ...
        private void ConstructorHelper()
        {
            ...
            _Locks = 0;
            _rootContext = new __HUB_Orchestration_root_0(this);
            _stateMgrs = new Microsoft.XLANGs.Core.IStateManager[2];
            _stateMgrs[0] = _rootContext;
            FinalConstruct();
        }

        public HUB_Orchestration(System.Guid instanceId, Microsoft.BizTalk.XLANGs.BTXEngine.BTXSession session, Microsoft.BizTalk.XLANGs.BTXEngine.BTXEvents tracker)
            : base(instanceId, session, "HUB_Orchestration", tracker)
        {
            ConstructorHelper();
        }

        public HUB_Orchestration(int callIndex, System.Guid instanceId, Microsoft.BizTalk.XLANGs.BTXEngine.BTXService parent)
            : base(callIndex, instanceId, parent, "HUB_Orchestration")
        {
            ConstructorHelper();
        }
...
<children>                          
<ShapeInfo>      <shapeType>MessagePartRefShape</shapeType>      <ShapeID>8efac2f4-7e8e-4b45-b68f-cd8ec7386039</ShapeID>      <ParentLink>Transform_InputMessagePartRef</ParentLink>                <shapeText>MessagePartReference_1</shapeText>                  
<children>                </children>
  </ShapeInfo>
                            
<ShapeInfo>      <shapeType>MessagePartRefShape</shapeType>      <ShapeID>5080a3ae-56f2-4aae-9845-fc3c1c392564</ShapeID>      <ParentLink>Transform_OutputMessagePartRef</ParentLink>                <shapeText>MessagePartReference_2</shapeText>                  
<children>                </children>
  </ShapeInfo>
                  </children>
  </ShapeInfo>
...
<children>                          
<ShapeInfo>      <shapeType>MessagePartRefShape</shapeType>      <ShapeID>fc827a27-8f17-4f00-aebf-4104eac5ff9e</ShapeID>      <ParentLink>Transform_OutputMessagePartRef</ParentLink>                <shapeText>MessagePartReference_4</shapeText>                  
<children>                </children>
  </ShapeInfo>
                            
<ShapeInfo>      <shapeType>MessagePartRefShape</shapeType>      <ShapeID>ff34d84a-8ff1-4279-aded-c561cb8bb7af</ShapeID>      <ParentLink>Transform_InputMessagePartRef</ParentLink>                <shapeText>MessagePartReference_3</shapeText>                  
<children>                </children>
  </ShapeInfo>
                  </children>
  </ShapeInfo>
...
";
        ...
        [System.SerializableAttribute]
        public class __HUB_Orchestration_root_0 : Microsoft.XLANGs.Core.ServiceContext
        {
            public __HUB_Orchestration_root_0(Microsoft.XLANGs.Core.Service svc)
                : base(svc, "HUB_Orchestration")
            {
            }
            ...
            {
                HUB_Orchestration __svc__ = (HUB_Orchestration)_service;
                __HUB_Orchestration_root_0 __ctx0__ = (__HUB_Orchestration_root_0)(__svc__._stateMgrs[0]);
        ...
        [System.SerializableAttribute]
        public class __HUB_Orchestration_1 : Microsoft.XLANGs.Core.LongRunningTransaction
        {
            public __HUB_Orchestration_1(Microsoft.XLANGs.Core.Service svc)
                : base(svc, "HUB_Orchestration")
            {
            }
        ...
        public static Microsoft.XLANGs.Core.PortInfo[] _portInfo = new Microsoft.XLANGs.Core.PortInfo[] {
            new Microsoft.XLANGs.Core.PortInfo(new Microsoft.XLANGs.Core.OperationInfo[] {PortType_ReceiveReceiptMessage.Operation_1},
                                               typeof(HUB_Orchestration).GetField("ReceiveReceiptMessage", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance),
                                               Microsoft.XLANGs.BaseTypes.Polarity.implements,
                                               false,
                                               Microsoft.XLANGs.Core.HashHelper.HashPort(typeof(HUB_Orchestration), "ReceiveReceiptMessage"),
                                               null),
            new Microsoft.XLANGs.Core.PortInfo(new Microsoft.XLANGs.Core.OperationInfo[] {PortType_SendPip4B2Message.Operation_1},
                                               typeof(HUB_Orchestration).GetField("SendPip4B2Message", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance),
                                               Microsoft.XLANGs.BaseTypes.Polarity.uses,
                                               false,
                                               Microsoft.XLANGs.Core.HashHelper.HashPort(typeof(HUB_Orchestration), "SendPip4B2Message"),
                                               null)
        };
        ...
        public Microsoft.XLANGs.Core.StopConditions segment0(Microsoft.XLANGs.Core.StopConditions stopOn)
        {
            ...
            __HUB_Orchestration_1 __ctx1__ = (__HUB_Orchestration_1)_stateMgrs[1];
            __HUB_Orchestration_root_0 __ctx0__ = (__HUB_Orchestration_root_0)_stateMgrs[0];
            ...
            case 0:
                ...
                goto case 1;
            case 1:
                __ctx1__ = new __HUB_Orchestration_1(this);
            ...
            case 1:
                {
                    ...
                    ApplyTransform(typeof(Kaifa.B2B.Mapping.ASN_To_4B2_STX), new object[] {__Pip4B2MessageForSTX.part}, new object[] {__ctx1__.__VendorReciptReportMessage.part});
            ...
            case 1:
                {
                    ...
                    ApplyTransform(typeof(Kaifa.B2B.Mapping.ASN_To_4B2_e2open), new object[] {__Pip4B2MessageForE2Open.part}, new object[] {__ctx1__.__VendorReciptReportMessage.part});
