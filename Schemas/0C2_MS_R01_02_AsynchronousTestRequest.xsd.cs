namespace Microsoft.Solutions.BTARN.Schemas.RNPIPs {
    ...
    [Schema(@"http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd",@"Pip0C2AsynchronousTestRequest")]
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "fromRole.PartnerRoleDescription.PartnerDescription.BusinessDescription.GlobalBusinessIdentifier", XPath = @"/*[local-name()='Pip0C2AsynchronousTestRequest' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='fromRole' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='PartnerRoleDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='PartnerDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='BusinessDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='GlobalBusinessIdentifier' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "toRole.PartnerRoleDescription.PartnerDescription.BusinessDescription.GlobalBusinessIdentifier", XPath = @"/*[local-name()='Pip0C2AsynchronousTestRequest' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='toRole' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='PartnerRoleDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='PartnerDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='BusinessDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='GlobalBusinessIdentifier' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']", XsdType = @"string")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"Pip0C2AsynchronousTestRequest"})]
    ...
    public sealed class _0C2_MS_R01_02_AsynchronousTestRequest : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:ns0=""http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:btarn=""http://Microsoft.Solutions.BTARN.Schemas.RNPIPs.BaseDataTypes"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  ...
  <xs:annotation>
    <xs:appinfo>
      <schemaInfo displayroot_reference=""Pip0C2AsynchronousTestRequest"" root_reference=""Pip0C2AsynchronousTestRequest"" xmlns=""http://schemas.microsoft.com/BizTalk/2003"" version=""R01.02"" document_type=""PIP0C2"" schema_name=""Asynchronous Request-Confirm"" />
      <b:references>
  ...
  <xs:element name=""Pip0C2AsynchronousTestRequest"">
    <xs:annotation>
      <xs:appinfo>
        <b:properties>
          <b:property distinguished=""true"" xpath=""/*[local-name()='Pip0C2AsynchronousTestRequest' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='fromRole' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='PartnerRoleDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='PartnerDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='BusinessDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='GlobalBusinessIdentifier' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']"" />
          <b:property distinguished=""true"" xpath=""/*[local-name()='Pip0C2AsynchronousTestRequest' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='toRole' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='PartnerRoleDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='PartnerDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='BusinessDescription' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']/*[local-name()='GlobalBusinessIdentifier' and namespace-uri()='http://schemas.microsoft.com/biztalk/btarn/2004/0C2_MS_R01_02_AsynchronousTestRequest.dtd']"" />
        </b:properties>
      </xs:appinfo>
    </xs:annotation>
  ...
  <xs:element name=""fromRole"">
    <xs:complexType>
      <xs:sequence>
        ...
        public _0C2_MS_R01_02_AsynchronousTestRequest() {
        }
        ...
        public override string[] RootNodes {
            get {
                ...
                _RootElements[0] = "Pip0C2AsynchronousTestRequest";
