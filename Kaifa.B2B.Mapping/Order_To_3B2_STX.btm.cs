namespace Kaifa.B2B.Mapping {
    ...
    public sealed class Order_To_3B2_STX : Microsoft.XLANGs.BaseTypes.TransformBase {
                ...
                <xsl:for-each select=""s0:ORDER"">
                  <xsl:for-each select=""s0:ORDERDETAIL"">
                    ...
                    <ns0:DocumentSubLineLotShipReference>
                      ...
                      <xsl:variable name=""var:v6"" select=""userCSharp:SeagateProprietarySite(string(../../../s0:config/s0:fromRole/s0:Site/text()) , string(../../../@CMCode))"" />
