...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0 userCSharp"" version=""1.0"" xmlns:ns0=""http://kaifa.b2b.schemas/Pip3B2AdvanceShipmentNotification"" xmlns:s0=""http://kaifa.b2b.schemas/OrderShipment"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/s0:VendorShipmentReport"">
    ...
    <xsl:variable name=""var:v12"" select=""userCSharp:StringTrimLeft(&quot;No&quot;)"" />
    <xsl:variable name=""var:v13"" select=""userCSharp:StringTrimLeft(&quot;Manufacturer&quot;)"" />
    <xsl:variable name=""var:v14"" select=""userCSharp:StringTrimRight(&quot;Shipper&quot;)"" />
    <xsl:variable name=""var:v15"" select=""userCSharp:StringTrimRight(&quot;Electronic Components&quot;)"" />
    <xsl:variable name=""var:v16"" select=""userCSharp:StringTrimRight(&quot;Freight Forwarder&quot;)"" />
    <xsl:variable name=""var:v17"" select=""userCSharp:StringTrimLeft(&quot;Request&quot;)"" />
    <xsl:variable name=""var:v20"" select=""userCSharp:StringTrimLeft(&quot;Receiver&quot;)"" />
    ...
    <ns0:Pip3B2AdvanceShipmentNotification>
            ...
            <ns0:ShippingContainerItem>
              <xsl:for-each select=""s0:ALL/s0:ORDER"">
                <xsl:for-each select=""s0:ORDERDETAIL"">
                  ...
                  <xsl:variable name=""var:v10"" select=""userCSharp:StringTrimLeft(&quot;RT&quot;)"" />
                  <ns0:DocumentSubLineLotShipReference>
                    ...
                    <ns0:SeagateProprietaryItems>
                      ...
                      <xsl:variable name=""var:v8"" select=""userCSharp:POformatter(string(s0:COMMODITYCLASS/text()) , string(s0:LOTTABLE03/text()) , string(../../../@CMCode))"" />
                      <ns0:SeagateProprietaryPONumber>
                        <xsl:value-of select=""$var:v8"" />
                      </ns0:SeagateProprietaryPONumber>
                      <xsl:variable name=""var:v9"" select=""userCSharp:DateTimeFormat(string(s0:TRANSACTIONDATE/text()))"" />
      ...
      <ns0:thisDocumentGenerationDateTime>
        <xsl:variable name=""var:v18"" select=""userCSharp:dateTimeNow()"" />
        <ns0:DateTimeStamp>
          <xsl:value-of select=""$var:v18"" />
        </ns0:DateTimeStamp>
      </ns0:thisDocumentGenerationDateTime>
      <ns0:thisDocumentIdentifier>
        <xsl:variable name=""var:v19"" select=""userCSharp:ProprietaryDocumentIdentifier(string(s0:config/s0:fromRole/s0:Site/text()) , &quot;ASN&quot; , string(@VendorDuns))"" />
        <ns0:ProprietaryDocumentIdentifier>
