  ...
  <xsl:template match=""/s0:VendorShipmentPODReport"">
    ...
    <ns0:Pip4B2ShipmentReceiptNotification>
      ...
      <xsl:for-each select=""s0:NOASIC/s0:ORDER"">
        ...
        <ns0:ShipmentReceiptInformationResource>
          ...
          <xsl:for-each select=""s0:ORDERDETAIL"">
            ...
            <xsl:variable name=""var:v16"" select=""string(../s0:CMCODE/text())"" />
            <ns0:ShipmentReceiptNotificationLineItem>
              ...
              <ns0:DocumentSubLineReference>
                ...
                <xsl:variable name=""var:v9"" select=""userCSharp:NONASICPurchaseOrder(string(s0:LOTTABLE03/text()) , string(../s0:CMCODE/text()))"" />
              ...
              <ns0:shipmentReceiptReportDateTime>
                <xsl:variable name=""var:v18"" select=""userCSharp:dateTimeNow0(string(s0:TRANSACTIONDATE/text()))"" />
                <ns0:DateTimeStamp>
      ...
      <ns0:thisDocumentIdentifier>
        <xsl:variable name=""var:v21"" select=""userCSharp:ProprietaryDocumentIdentifier(string(s0:config/s0:fromRole/s0:Site/text()) , string(@VendorCode) , &quot;POD&quot;)"" />
        <ns0:ProprietaryDocumentIdentifier>
